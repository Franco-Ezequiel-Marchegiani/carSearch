...
marca.addEventListener('input', e => {
    ...
    //Mandar a llamar la función "filtrar Autos"
    filtrarAuto();
...
function mostrarAutos(autos){
    ...
    // Lee el elemento Resultado
    const contenedor = document.querySelector('#resultado');

    // Construye el HTML de los autos
    autos.forEach(auto => {
...
function noResultado(){
    ...
    noResultado.appendChild(document.createTextNode('No hay Resultados Disponibles'));
